...
//
// The CLI commands (`install`, `uninstall`, `status`, `doctor`, `update`)
// default to the real filesystem in production. Tests inject an in-memory
// adapter via the second argument to keep everything deterministic and fast.
//
